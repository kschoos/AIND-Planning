...
class AirCargoProblem(Problem):
    def __init__(self, cargos, planes, airports, initial: FluentState, goal: list, relaxed=False):
        """
        ...
        if not relaxed:
            ...
            self.relaxed_problem.actions = lambda _: self.relaxed_actions_list
    ...
    def result(self, state: str, action: Action):
        ...
        neg = decoded_state.neg.copy()

        for pos_effect in action.effect_add:
            pos.append(pos_effect)
            try:
                neg.remove(pos_effect)
            except ValueError:
                pass

        for neg_effect in action.effect_rem:
            neg.append(neg_effect)
            try:
                pos.remove(neg_effect)
            except ValueError:
                pass
